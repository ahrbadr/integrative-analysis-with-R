...
### load the CEL files
celFilesDirectory_GDS596="data/microarray"
...
write.exprs(eset,file="data/microarray/expData.processed.txt")

#### Now you can continue where we started last time. 


### load already processed data
data <- read_delim("data/microarray/expData.processed.txt", "\t", escape_double = FALSE, trim_ws = TRUE)
